...
for max_iter in ${max_iter_list[@]}; do
    ...
    # inpaint box
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/afhq/inpaint_box.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 109 --clamp_to 1.0 --max_iter $max_iter
    # inpaint pixel
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/afhq/inpaint_pixel.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 53 --clamp_to 1.0 --max_iter $max_iter
    # deblur
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/afhq/deblur.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 15 --clamp_to 1.0 --max_iter $max_iter
    # super-res
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/afhq/super_res.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 2 --clamp_to 1.0 --max_iter $max_iter
done

for max_iter in ${max_iter_list[@]}; do
    echo "Running qualitative evaluation for max_iter = $max_iter for CelebA dataset"
    # inpaint box
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/celeba/inpaint_box.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 109 --clamp_to 1.0 --max_iter $max_iter --sampling_var 0.0 
    # inpaint pixel
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/celeba/inpaint_pixel.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 1253 --clamp_to 1.0 --max_iter $max_iter --sampling_var 0.0
    # deblur
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/celeba/deblur.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 1547 --clamp_to 1.0 --max_iter $max_iter --sampling_var 0.0
    # super-res
    python run_qualitative.py --config /content/InvGenPrior/configs/tmpd/celeba/super_res.py --workdir /content/InvGenPrior/ --sample_N $sample_N --noise_sigma 0.01 --data_index 389 --clamp_to 1.0 --max_iter $max_iter --sampling_var 0.0
done
